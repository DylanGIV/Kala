...
function HomeStack(props) {
    ...
    return (
        <Stack.Navigator initialRouteName="Home" >
            <Stack.Screen name="Profile" component={ProfileScreen} options={{ headerLeft: () => (<IconButton onPress={() => props.navigation.goBack()} icon='chevron-down' color={theme.colors.text} size={30} />),
                                                                                ...
                                                                                headerTitle: '', headerStyle: { backgroundColor: theme.colors.background, elevation: 0, borderBottomWidth: 0 }, headerTintColor: theme.colors.text }} />
